...
@section('konten')
@section('title' ,'Halaman Merk')
@section('page','Data Merk')
...
<script type="text/javascript">
    ...
    function create() {
        ...
        $.get("{{ url('merk/create') }}", {}, function (data, status) {
    ...
    function edit(uuid) {
        $.get(`{{ url('merk/${uuid}/edit') }}`, {}, function (data, status) {
            $('#btn-modal').click();
            $("#modal").html(data);
        });
    }
