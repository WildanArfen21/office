...
@section('konten')
@section('title' ,'Halaman Jenis Pengadaan')
@section('page','Data Jenis Pengadaan')
...
<script type="text/javascript">
    function read() {
        $.get("{{ url('jenis-pengadaan/read') }}", {}, function (data, status) {
            $('#close-modal').click();
            $('#close-modal').click();
            $("#read").html(data);
        });
    ...
    function create() {
        ...
        $.get("{{ url('jenis-pengadaan/create') }}", {}, function (data, status) {
    ...
    function edit(uuid) {
        $.get(`{{ url('jenis-pengadaan/${uuid}/edit') }}`, {}, function (data, status) {
            $('#btn-modal').click();
            $("#modal").html(data);
        });
    }
    ...
    function update(uuid) {
        ...
        $.ajax({
            type: "PUT",
            url: `{{ url('jenis-pengadaan/${uuid}/update') }}`,
            data: data,
            dataType: "json",
            success: function (response) {
                // console.log(response);
    ...
    function destroy(uuid) {
        $.ajax({
            type: "get",
            url: `{{ url('jenis-pengadaan/${uuid}/destroy') }}`,
            dataType: "json",
            success: function (response) {
                // console.log(response);
