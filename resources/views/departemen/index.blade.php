...
<script type="text/javascript">
    $(function () {
        ...
        $('#createNewPost').click(function () {
            ...
            $('#modelHeading').html("Create Data Departemen");
        });
        ...
        $('body').on('click', '.editPost', function () {
            ...
            $.get(`{{ url('departemen/${uuid}/edit') }}`, function (data) {
                $('#createNewPost').click();
                $('#modelHeading').html("Edit Data Departemen");
        ...
        $('body').on('click', '.deletePost', function () {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('departemen.store') }}" + '/' + uuid,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
