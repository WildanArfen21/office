...
<script type="text/javascript">
    function read() {
        $.get("{{ url('departemen/read') }}", {}, function (data, status) {
            $('#close-modal').click();
            $('#close-modal').click();
            $("#read").html(data);
        });
    ...
    function create() {
        ...
        $.get("{{ url('departemen/create') }}", {}, function (data, status) {
    ...
    function edit(uuid) {
        $.get(`{{ url('departemen/${uuid}/edit') }}`, {}, function (data, status) {
            $('#btn-modal').click();
            $("#modal").html(data);
        });
    }
    ...
    function update(uuid) {
        ...
        $.ajax({
            type: "PUT",
            url: `{{ url('departemen/${uuid}/update') }}`,
            data: data,
            dataType: "json",
            success: function (response) {
                // console.log(response);
    ...
    function destroy(uuid) {
        $.ajax({
            type: "get",
            url: `{{ url('departemen/${uuid}/destroy') }}`,
            dataType: "json",
            success: function (response) {
                // console.log(response);
